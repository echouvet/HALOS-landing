  ...
  return (
    <main className="min-h-screen bg-halos-paper py-16 text-halos-ink dark:bg-halos-ink-900 dark:text-halos-ink-100">
      <div className="container mx-auto max-w-4xl">
        ...
        <h1 className="mb-8 font-display text-4xl font-light tracking-[-0.015em] text-halos-ink dark:text-halos-ink-100">Terms of Use</h1>

        <div className="max-w-none space-y-6 text-halos-ink-600 dark:text-halos-ink-300">
          <section className="space-y-4">
            <h2 className="text-2xl font-bold text-halos-ink dark:text-halos-ink-100">Acceptance of Terms</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-bold text-halos-ink dark:text-halos-ink-100">Research Use Only</h2>
            <p className="font-bold text-halos-ink dark:text-halos-ink-100">
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-bold text-halos-ink dark:text-halos-ink-100">No Investment Solicitation</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-bold text-halos-ink dark:text-halos-ink-100">Intellectual Property</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-bold text-halos-ink dark:text-halos-ink-100">Disclaimer of Warranties</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-bold text-halos-ink dark:text-halos-ink-100">Limitation of Liability</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-bold text-halos-ink dark:text-halos-ink-100">Changes to Terms</h2>
            <p>
