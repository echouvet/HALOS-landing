  ...
  return (
    <main className="min-h-screen bg-halos-paper py-16 text-halos-ink">
      <div className="container mx-auto max-w-4xl">
        ...
        <h1 className="mb-8 font-display text-4xl font-light tracking-[-0.015em] text-halos-ink">Privacy Policy</h1>

        <div className="max-w-none space-y-6 text-halos-ink-600">
          <section className="space-y-4">
            <h2 className="text-2xl font-bold text-halos-ink">Introduction</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-bold text-halos-ink">Information We Collect</h2>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-bold text-halos-ink">How We Use Your Information</h2>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-bold text-halos-ink">Data Protection</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-bold text-halos-ink">Your Rights</h2>
