  ...
  return (
    <main className="min-h-screen bg-canvas py-16 text-ink">
      <div className="container mx-auto max-w-4xl">
        ...
        <h1 className="mb-8 font-display text-4xl font-light tracking-[-0.015em] text-ink">Privacy Policy</h1>
        ...
        <div className="max-w-none space-y-6 text-ink-muted">
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-bold text-ink">How We Use Your Information</h2>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-bold text-ink">Data Protection</h2>
            <p>
